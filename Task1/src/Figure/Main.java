...
public class Main extends JFrame{    //draw point
    ...
    public Main(){
        ...
        Dimension drawGeometryPanel = new Dimension(screenSizeX - panelX, screenSizeY - panelY);
        p.setPreferredSize(drawGeometryPanel);
        p.setMinimumSize( drawGeometryPanel);
    ...
    private void addGeometryIntoList(){
        ...
        //assign the point, line and circle into Aggregation Class Object: geometryList
